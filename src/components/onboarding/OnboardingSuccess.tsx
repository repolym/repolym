        ...
        >
            ...
            <div className="mb-8 w-full max-w-xs mx-auto aspect-square bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 rounded-3xl flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0 opacity-20">
                    <div className="absolute top-0 left-0 w-32 h-32 rounded-full bg-accent blur-3xl" />
            ...
            <p className="text-sm md:text-base text-text-secondary max-w-sm leading-relaxed">
                ...
                <br />
                <span className="text-accent font-medium">موفق باشید و از Repolym لذت ببرید.</span>
            </p>

            {/* Button */}
            <button
                onClick={() => navigate('/dashboard', { replace: true })}
                className="mt-8 inline-flex items-center gap-2 px-8 py-3 bg-accent hover:bg-accent-hover text-white text-base font-semibold rounded-2xl transition-all shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50"
            >
                رفتن به داشبورد →
            </button>
        </motion.div>
