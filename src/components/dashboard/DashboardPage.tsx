                ...
                >
                    <Suspense fallback={<SectionSkeleton />}>
                        <ErrorBoundary>
                            ...
                            {activeTab === 'growth' && <GrowthSection sessions={sessions.data} loading={sessions.loading} />}
                            {activeTab === 'leaderboard' && <LeaderboardSection userId={user?.id ?? null} olympiadId={user?.olympiad_id ?? null} />}
