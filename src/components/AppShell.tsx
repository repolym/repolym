...
// ناوبری ادمین
const adminNavItems = [
  { to: '/admin', label: 'داشبورد ادمین', icon: LayoutDashboard },
  // در صورت نیاز می‌توانید بعداً اضافه کنید:
...
export const AppShell: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // انتخاب آیتم‌های ناوبری بر اساس نقش
  const allNavItems = user?.is_admin ? adminNavItems : studentNavItems
