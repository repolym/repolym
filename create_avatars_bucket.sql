...
-- اضافه شدن ایندکس‌های جدید برای عملکرد بهتر
...
-- ========================================
-- RPC: get_public_study_profile (fixed)
-- ========================================
...
DECLARE
    result JSONB;
BEGIN
    -- تنها در صورت احراز هویت و درخواست داده‌ی خود کاربر مجاز است
...
-- =============================================
-- RPC: get_analytics (fixed for new users)
-- =============================================
...
-- ========================================
-- RPC: get_olympiad_leaderboard (fixed signature)
-- ========================================
